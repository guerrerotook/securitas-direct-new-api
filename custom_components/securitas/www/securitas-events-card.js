...
const TRANSLATIONS = {
  en: {
    ...
    refresh: "Refresh",
    unknown_event_prompt: "Please screenshot this event and create an issue at https://github.com/clintongormley/securitas-direct-new-api/issues so that we can document this unknown event type.",
  ...
  es: {
    ...
    refresh: "Actualizar",
    unknown_event_prompt: "Captura una imagen de este evento y abre una incidencia en https://github.com/clintongormley/securitas-direct-new-api/issues para que podamos documentar este tipo de evento desconocido.",
  ...
  it: {
    ...
    refresh: "Aggiorna",
    unknown_event_prompt: "Fai uno screenshot di questo evento e apri una segnalazione su https://github.com/clintongormley/securitas-direct-new-api/issues così possiamo documentare questo tipo di evento sconosciuto.",
  ...
  fr: {
    ...
    refresh: "Actualiser",
    unknown_event_prompt: "Prenez une capture d'écran de cet événement et créez un ticket sur https://github.com/clintongormley/securitas-direct-new-api/issues afin que nous puissions documenter ce type d'événement inconnu.",
  ...
  pt: {
    ...
    refresh: "Atualizar",
    unknown_event_prompt: "Capture uma imagem deste evento e crie um problema em https://github.com/clintongormley/securitas-direct-new-api/issues para podermos documentar este tipo de evento desconhecido.",
  ...
  "pt-BR": {
    ...
    from_home_assistant: "Emitido pelo Home Assistant",
    refresh: "Atualizar",
    unknown_event_prompt: "Faça uma captura de tela deste evento e crie uma issue em https://github.com/clintongormley/securitas-direct-new-api/issues para podermos documentar este tipo de evento desconhecido.",
  ...
  ca: {
    ...
    refresh: "Actualitza",
    unknown_event_prompt: "Feu una captura de pantalla d'aquest esdeveniment i obriu una incidència a https://github.com/clintongormley/securitas-direct-new-api/issues perquè puguem documentar aquest tipus d'esdeveniment desconegut.",
