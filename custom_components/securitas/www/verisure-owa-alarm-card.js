...
// `securitas-*` tag-name aliases for the canonical `verisure-owa-*`
// cards. Kept registered indefinitely — both names are equal-weight,
// no deprecation. The card picker only offers the verisure-owa form.
