...
// old resources). Forwards to the canonical file, which registers BOTH
...
//
// ES modules dedup by URL, so loading both this file AND
// /verisure-owa-panel/verisure-owa-alarm-card.js as Lovelace resources
// causes the canonical code to run once: customElements.define is
// guarded by `if (!customElements.get(...))` to make any duplicate-
// registration attempt a silent no-op.
//
